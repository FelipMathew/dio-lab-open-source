...
| ---------------|----------------------------------------------------------------------|-----------
| `feat`         | Adiciona uma nova funcionalidade ao projeto.                         | `feat: add ESPANHOL.md profile`
...
1. PYTHON, Contributing to Python
2. CONVENTIONAL COMMITS, Summary
3. GITHUB, Configurar diretrizes para os contribuidores do repositório
